...
import PinewoodBike, { IPinewoodBikeModel } from '../models/PinewoodBike'

const createPinewoodBike = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
const readPinewoodBike = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
const updatePinewoodBike = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const pinewoodBikeId = req.params.pinewoodBikeId
...
const deletePinewoodBike = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const pinewoodBikeId = req.params.pinewoodBikeId
...
const filterByPriceRange = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
const filterByCategory = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
const getAllModels = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
const filterByPriceCategory = async (req: Request, res: Response, next: NextFunction) => {
  try {
